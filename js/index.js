...
function loadVideo(keyword){
    ...
    "&type=video&maxResults=9&part=snippet&key=AIzaSyAwUjk3CwtXCiB_W6Xi0colf0KPgm90hHc";
    ...
    xhr.onreadystatechange = function(){
        if(this.readyState == 4 && this.status == 200){
            ...
            for (var i = 0; i < responseJson.items.length; i++) {
                ...
                var videoDescription = responseJson.items[i].snippet.thumbnails.description;
                var videoThumbnails = responseJson.items[i].snippet.thumbnails.medium,url;
